    ...
    <div className="container section">
      ...
      <div className="grid-2">
        ...
        <div className="card">
          ...
          <ul className={styles.list}>
            ...
            <li><strong>Gibson-Ashby Scaling:</strong> Relative density scales as \(\rho^* / \rho_s \approx \frac{2}{\sqrt{3}}\frac{t}{l}\).</li>
      ...
      <div className={`card ${styles.analogyCard}`} style={{ marginTop: "1.5rem" }}>
        ...
        <div className={styles.analogyGrid}>
          ...
          <div className={styles.analogyCol}>
            ...
            <div className={styles.analogyItem}>
              <strong>Local Demand Proxy (\(D_i\)):</strong> Computed from load-path factor, vertical position, and orientation alignment.
            </div>
            <div className={styles.analogyItem}>
              <strong>Material Thickening (\(t_i\)):</strong> High demand yields target relative density \(\rho_i \uparrow\) and strut radius \(r_i \uparrow\).
            </div>
            <div className={styles.analogyItem}>
              <strong>Iterative Redistribution (\(\gamma\)):</strong> Step-wise density update \(\rho_{k+1} = (1-\gamma)\rho_k + \gamma\rho_{\text{target}}\).
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid-3">
        ...
        <div className="card">
          ...
          <div className={styles.equation}>
            \(D_i = \text{norm}(W_i \cdot L_i \cdot O_i \cdot F_{\text{norm}})\)
          </div>
          <div className={styles.equation}>
            \(\rho_i = \text{clamp}(\rho_{\text{base}}[1 + \alpha(D_i - 0.5)], \rho_{\min}, \rho_{\max})\)
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className={styles.equation}>
            \(\delta_{\text{visual}} = \text{scale} \cdot F_{\text{norm}} \cdot \frac{1}{E_{\text{rel}}}\)
          </div>
        </div>
      </div>
